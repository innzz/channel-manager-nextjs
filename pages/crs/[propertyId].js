              ...
              <Col className={styles.dates}>
                <Row className={styles.dateCards}>
                  {sevenDaysDataOfRoom?.map((val, i) => {
                    ...
                    return (
                      <Col className={`${styles.dateCard} text-gray-200`} key={i}>
                        <span>
                          {date.getDay() == 1
                            ? "MON"
                            : date.getDay() == 2
                  ...
                  <div key={i} className={`${styles.item}`}>
                    <Row className={`${styles.heading} flex items-center`}>
                      <Col className={styles.Icon}>
                        <FaBed size={23} className="text-gray-200" style={{ marginTop: "5px" }} />
                      </Col>
                      <Col
                        className={`${styles.leftSection} flex items-center ml-1`}
                      >
                        <span className="font-bold text-xl text-gray-200">{val.name}</span>
                      </Col>
                                      ...
                                      <Row className={styles.data}>
                                        {sevenDaysDataOfRoom?.map(
                                          (planRatesOfSevenDays) => {
                                            console.log("planRatesOfSevenDays" , planRatesOfSevenDays)
                                            return (
                                              <>
                                                {planRatesOfSevenDays?.roomRatePlans?.map(
                                                  (plansRatesToShow, keyi) => {
                                                    console.log("plansRatesToShow" , plansRatesToShow)
                                                    return (
                                                      <>
                                                        {planName.name ==
