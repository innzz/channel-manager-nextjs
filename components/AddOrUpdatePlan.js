                      ...
                      <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex justify-between py-2 px-2">
                          <div className="relative inline-block text-left">
                            ...
                            {planMenu === true ? <div className="absolute left-0 z-10 mt-1 w-96 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                                  ...
                                  return (
                                    <div key={ji}>
                                      <div className="py-1" role="none">
                                        <a href="#" onClick={() => {
                                          setChoosePlan(plans.name), setPlanMenu(!planMenu), setCode(plans.code), setName(plans.name), setDescription(plans.description
                                          ), setMinOccupancy(plans.minimumOccupancy), setMaxOccupancy(plans.maximumOccupancy), setExtraCharge(plans.extraChargePerPerson), setNoOfChild(plans.noOfChildren), setExtraChargePerPerson(plans.extraChargePerChild3To5yrs), setExtraChargePerChild(plans.extraChargePerChild), setChecked(true)
                                        }} className="text-gray-700 rounded-lg hover:bg-blue-400 hover:text-white hover:mx-3 block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-0">{plans.name}</a>
                                      </div>
                                    </div>)
                                })}
                            </div> : <></>}
                            <div className="mx-3 flex flex-wrap w-96 gap-2 mt-3">
                              ...
                              <div className="">
                                <input
                                  ...
                                  type="text"
                                  id=""
                                  onChange={(e) => setExtraChargePerPerson(e.target.value)}
                              ...
                              <div className="">
                                <input
                                  ...
                                  name=""
                                  onChange={(e) => setExtraChargePerChild(e.target.value)}
                          ...
                          <div>
                            ...
                            <div className="mt-3 px-1 flex flex-wrap">
                              ...
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Tuesday</span>
                              </div>
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Wednesday</span>
                              </div>
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Thursday</span>
                              </div>
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Friday</span>
                              </div>
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Saturday</span>
                              </div>
                              <div className="w-40">
                                <input type="checkbox" checked={checked} name="" value="" className="" ></input>
                                <span className="text-base ml-2 font-normal">Sunday</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div>
                          <div className="flex gap-3 ml-1 px-4 py-2">
                            <div className="flex gap-1">
                              <input type="radio" checked={radio == "rate" ? true : false} onClick={() => setRadio("rate")} />
                              <label>Rate</label>
                            </div>
                            <div className="flex gap-1">
                              <input type="radio" checked={radio == "restrictions" ? true : false} onClick={() => setRadio("restrictions")} />
                          ...
                          {radio === "restrictions" ?
                            <div className="mx-6 flex flex-wrap gap-2 border-2 px-3 py-1 pb-2 rounded-lg mb-3">
                              <div>
                                ...
                                <div>
                                  <input type="text" placeholder="Max Length Of Stay" className="inline-flex w-40 justify-between rounded-md border border-gray-300 bg-white px-2 py-2 text-xs font-base text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" name="quantity" min="1"></input>
                                </div>
                              </div>
                              <div>
                                <span>Min Length Of Stay</span>
                                <div>
                                  <input type="text" placeholder="Min Length Of Stay" className="inline-flex w-40 justify-between rounded-md border border-gray-300 bg-white px-2 py-2 text-xs font-base text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" name="quantity" min="1"></input>
                                </div>
                              </div>
                              <div>
                                <span>Status</span>
                                <div>
                                  <button type="button" className="inline-flex w-40 justify-between rounded-md border border-gray-300 bg-white px-2 py-2 text-xs font-base text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" onClick={() => setCurrencyMenu(!currencyMenu)} aria-expanded="true" aria-haspopup="true">
                                    Status
                                    <svg className="-mr-1 ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                      <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                                    </svg>
                            ...
                            : <div className="mx-6 flex flex-wrap gap-2 border-2 px-3 py-1 pb-2 rounded-lg mb-3">
                              <div>
                                ...
                                {currencyMenu === true ? <div className="absolute left-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                                  {props.sevenDaysDataOfRoom[0]?.roomRatePlans?.map(
                                    (plans, ji) => {
                                      return (
                                        <div key={ji}>
                              ...
                              <div>
                                ...
                                <div>
                                  <input type="number" className="inline-flex w-40 justify-between rounded-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" name="quantity" min="1"></input>
                                </div>
                              </div>
                              <div>
                                <span>More Than Standard Rate (%)</span>
                                <div>
                                  <input type="number" className="inline-flex w-44 justify-between rounded-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" name="quantity" min="1"></input>
                                </div>
                              </div>
                              <div>
                                <span>Amount</span>
